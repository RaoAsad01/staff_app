...
// Default country code (you can change this to your preferred default)
export const defaultCountryCode = countryCodes.find(country => country.code === 'PK') || countryCodes[0];
